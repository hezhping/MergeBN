...
path.append('/root/RefineDet/python/')
import argparse
...
class ConvertBnn:
    ...
    def pre_process(self):
                ...
                if (i + 2 < length) and layer_params[i + 1].type == bnn_type[0] and  \
                    layer_params[i + 2].type == bnn_type[1]:
                        ...
                        if len(params) < 2:
                            ...
                            if layer_params[i].type == 'Convolution' or layer_params[i].type == 'DepthwiseConvolution':
        ...
        for i, layer in enumerate(model_layers):
            if layer.type == 'Convolution' or layer.type == 'InnerProduct' or layer.type == 'Scale' or layer.type == 'DepthwiseConvolution':
